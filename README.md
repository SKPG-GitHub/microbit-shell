...
# What is this?
**microbit-shell** is a shell that runs on a micro:bit. We know sounds crazy to do such things on a micro:bit. The shell is about 200 lines of code. The shell is suffering from a few issues due to the limits being almost reached. _This project was made in the Makecode editor using Javascript_.
